...
<body style="background-color:#C29BB6;">
  <form>
    ...
    <div class="card">
      ...
      <label for="rank1"><b>{{Session::get('Frock')}}</b></label><br>
    ...
    <div class="card">
      <label for="Cloth">Your Clothing preferences:</label><br>
      <label for="Type"><b>Cloth Type: {{Session::get('PereferredClothType')}}</b></label><br>
      <label for="Length"><b>Length: {{Session::get('PereferredLength')}}</b></label><br>
      <label for="Neckline"><b>Neckline: {{Session::get('PereferredNeck')}}</b></label><br>
      <label for="Pattern"><b>Pattern: {{Session::get('PereferredPattern')}}</b></label><br>
      <label for="Sleeve"><b>Sleeve Type: {{Session::get('PereferredSleeve')}}</b></label>
    </div>
