...
<body>
  <div class="container mt-5">
    ...
    <form action="/StoreUserProfileDetails" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-6">
            ...
            <div class="card upload-card">
                ...
                <div class="row">
                    ...
                    <select id="skin_sensitivity" name="skin_sensitivity" class="form-control">
            ...
            <div class="card upload-card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="card inner-card">
                        <div class="card-body d-flex align-items-center justify-content-center">
                            <img src="{{'images/Body_M.png'}}" alt="Image" class="img-fluid" style="width: 350px; height: 200px;">
                        </div>
                        </div>
                    </div>
                    <div class="col-md-10">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col">
                                <div class="form-group">
                                <label for="shoulder-width">Shoulder Width (Inch):</label>
                                <div class="input-group">
                                    <input type="number" id="shoulder_width" name="shoulder_width" class="form-control">
                                </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                <label for="bust-width">Bust Width (Inch):</label>
                                <div class="input-group">
                                    <input type="number" id="bust_width" name="bust_width" class="form-control">
                                </div>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                <label for="shoulder-width">Waist Size (Inch):</label>
                                <div class="input-group">
                                    <input type="number" id="waist_width" name="waist_width" class="form-control">
                                </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                <label for="bust-width">Hip Size (Inch):</label>
                                <div class="input-group">
                                    <input type="number" id="hip_size" name="hip_size" class="form-control">
                                </div>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label for="shoulder-width">Height (Inch):</label>
                                    <div class="input-group">
        ...
        <div class="card inner-card">
            <div class="card-body">
            <div class="form-group text-center">
                <input type="file" name="PrefferedOutfits[]" class="form-control" id="images" multiple="multiple">
            </div>
            </div>
        </div>
        </div>
        <button type="submit" class="btn btn-primary btn-lg" value="Submit" style="position: absolute; left: 1200px; top:1250px;">Save</button>
        <button type="Reset" class="btn btn-secondary btn-lg" value="Reset"style="position: absolute; left: 1300px; top:1250px;">Cancel</button>
    </form>
    </div>
    <br><br>
</body>
